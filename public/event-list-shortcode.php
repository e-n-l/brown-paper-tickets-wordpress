...
<script type="text/ractive" id="bpt-event-template">
{{ #bptEvents }}
            ...
            <div class="bpt-event-footer">
                <div class="bpt-add-to-cart">
                    ...
                    <span class="bpt-cc-logos">
                        <img src="<?php echo plugins_url( 'assets/img/visa_icon.png', __DIR__ ); ?>" />
                        <img src="<?php echo plugins_url( 'assets/img/mc_icon.png', __DIR__ ); ?>" />
                        <img src="<?php echo plugins_url( 'assets/img/discover_icon.png', __DIR__ ); ?>" />
